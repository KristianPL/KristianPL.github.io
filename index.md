...
Key features:
- Extensive and customizable stereo Unison modules
- Single-page layout displays precise parameter values for all sliders in plain view for the active patch.
- Specialising in rich Oberheim/Sequential analog synth tones and pads
